...
public class Virsual_input : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if((mytouch.phase == TouchPhase.Began || mytouch.phase == TouchPhase.Stationary || mytouch.phase == TouchPhase.Moved) &&mytouch.position.x >= (float)Screen.width/2) 
        {
        ...
        if ((mytouch.phase == TouchPhase.Began||mytouch.phase == TouchPhase.Stationary|| mytouch.phase == TouchPhase.Moved)&&button_Left_State == Button_Left_State.Up&&button_Right_State == Button_Right_State.Up 
